...
import ProposalInfo from "./proposaInfo";
const ProposalTable = () => {
  // ===============modal view state===================
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> <span className="">Proposal's Information</span> </Modal.Title>
        </Modal.Header>
        <Modal.Body>
       <ProposalInfo/>
        </Modal.Body>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> <span className="text-danger">Delete Proposal</span> </Modal.Title>
        </Modal.Header>
        <Modal.Body>
